...
static const uint8_t offsets[] = {6,6,12,12};
///---Colors---///
/*0)focuscol         1)unfocuscol
 *2)fixedcol         3)unkilcol
 *4)fixedunkilcol    5)outerbordercol
 *6)emptycol         */
static const char *colors[] = {"#b9b9b9","#303030","#7a8c5c","#ff6666","#cc9933","#0d131a","#000000"};
...
///--Menus and Programs---///
static const char *menucmd[]   = { "dmenu_run", "-p", "launch:", NULL };
static const char *terminal[]  = { "st", NULL };
static const char *vol_up[]    = { "amixer", "-q", "sset", "Master", "3%+", "unmute", NULL };
static const char *vol_down[]  = { "amixer", "-q", "sset", "Master", "3%-", "unmute", NULL };
static const char *vol_mute[]  = { "amixer", "-q", "sset", "Master", "mute", NULL };
static const char *prnt_scr[]  = { "scrot", "~/Pictures/Screenshots/%Y-%m-%d-%T-screenshot.png",  NULL };
///--Custom foo---///
...
static key keys[] = {
    ...
    {  0x000000,	XK_Print,	start,		{.com = prnt_scr}},
