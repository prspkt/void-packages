 ...
 */
static const char * const BAR_FONT = "Terminus:size=8";

/* colors:
 * (see X(7) section "COLOR NAMES" for valid values)
 */
static const char * const WIN_BG_COLOR = "#303030";
static const char * const WIN_FS_COLOR = "#F7F7F7";
static const char * const SEL_COLOR    = "#B9B9B9";
static const char * const BAR_BG_COLOR = "#303030";
static const char * const BAR_FG_COLOR = "#B9B9B9";
